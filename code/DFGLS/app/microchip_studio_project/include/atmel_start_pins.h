 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void LED_CS_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(2, pull_mode);
}

/**
 * \brief Set LED_CS data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
...
/**
 * \brief Set LED_CS input/sense configuration
 *
 * Enable/disable LED_CS digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void LED_CS_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(2, isc);
}

/**
 * \brief Set LED_CS inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on LED_CS is inverted
 *                     false = I/O on LED_CS is not inverted
 */
static inline void LED_CS_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(2, inverted);
}

/**
 * \brief Set LED_CS level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
...
/**
 * \brief Toggle output level on LED_CS
 *
 * Toggle the pin level
 */
static inline void LED_CS_toggle_level()
{
	PORTA_toggle_pin_level(2);
}

/**
 * \brief Get level on LED_CS
 *
 * Reads the level on a pin
 */
static inline bool LED_CS_get_level()
{
	return PORTA_get_pin_level(2);
}

/**
 * \brief Set LED_OUT_DAT pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void LED_OUT_DAT_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(3, pull_mode);
}

/**
 * \brief Set LED_OUT_DAT data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
...
/**
 * \brief Set LED_OUT_DAT input/sense configuration
 *
 * Enable/disable LED_OUT_DAT digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void LED_OUT_DAT_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(3, isc);
}

/**
 * \brief Set LED_OUT_DAT inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on LED_OUT_DAT is inverted
 *                     false = I/O on LED_OUT_DAT is not inverted
 */
static inline void LED_OUT_DAT_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(3, inverted);
}

/**
 * \brief Set LED_OUT_DAT level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
...
/**
 * \brief Toggle output level on LED_OUT_DAT
 *
 * Toggle the pin level
 */
static inline void LED_OUT_DAT_toggle_level()
{
	PORTA_toggle_pin_level(3);
}

/**
 * \brief Get level on LED_OUT_DAT
 *
 * Reads the level on a pin
 */
static inline bool LED_OUT_DAT_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void LED_ON_N_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTC_set_pin_pull_mode(6, pull_mode);
}

/**
 * \brief Set LED_ON_N data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void LED_ON_N_set_dir(const enum port_dir dir)
{
	PORTC_set_pin_dir(6, dir);
}

/**
 * \brief Set LED_ON_N input/sense configuration
 *
 * Enable/disable LED_ON_N digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void LED_ON_N_set_isc(const PORT_ISC_t isc)
{
	PORTC_pin_set_isc(6, isc);
}

/**
 * \brief Set LED_ON_N inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on LED_ON_N is inverted
 *                     false = I/O on LED_ON_N is not inverted
 */
static inline void LED_ON_N_set_inverted(const bool inverted)
{
	PORTC_pin_set_inverted(6, inverted);
}

/**
 * \brief Set LED_ON_N level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void LED_ON_N_set_level(const bool level)
{
	PORTC_set_pin_level(6, level);
}

/**
 * \brief Toggle output level on LED_ON_N
 *
 * Toggle the pin level
 */
static inline void LED_ON_N_toggle_level()
{
	PORTC_toggle_pin_level(6);
}

/**
 * \brief Get level on LED_ON_N
 *
 * Reads the level on a pin
 */
static inline bool LED_ON_N_get_level()
{
	return PORTC_get_pin_level(6);
}

/**
 * \brief Set LED_MCLK pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void LED_MCLK_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTC_set_pin_pull_mode(7, pull_mode);
}

/**
 * \brief Set LED_MCLK data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
...
/**
 * \brief Set LED_MCLK input/sense configuration
 *
 * Enable/disable LED_MCLK digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void LED_MCLK_set_isc(const PORT_ISC_t isc)
{
	PORTC_pin_set_isc(7, isc);
}

/**
 * \brief Set LED_MCLK inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on LED_MCLK is inverted
 *                     false = I/O on LED_MCLK is not inverted
 */
static inline void LED_MCLK_set_inverted(const bool inverted)
{
	PORTC_pin_set_inverted(7, inverted);
}

/**
 * \brief Set LED_MCLK level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
...
/**
 * \brief Toggle output level on LED_MCLK
 *
 * Toggle the pin level
 */
static inline void LED_MCLK_toggle_level()
{
	PORTC_toggle_pin_level(7);
}

/**
 * \brief Get level on LED_MCLK
 *
 * Reads the level on a pin
 */
static inline bool LED_MCLK_get_level()
{
...
/**
 * \brief Set PE6 input/sense configuration
 *
 * Enable/disable PE6 digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void PE6_set_isc(const PORT_ISC_t isc)
{
	PORTE_pin_set_isc(6, isc);
}

/**
 * \brief Set PE6 inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on PE6 is inverted
 *                     false = I/O on PE6 is not inverted
 */
static inline void PE6_set_inverted(const bool inverted)
{
